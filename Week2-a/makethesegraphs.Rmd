...
The file climatetemperatures.RData is a list with two data frames. Temperature_by_year is used in the first plot; futureeuropetemp is based off of 15 or so climate models predicting the temperature of european countries in the end of the 21st centure. Hint: The 95 percent confidence intervals (which are plotted below are 1.96 times the standard error over/under the mean)
